...
## 🗂 Структура ВКР
1. **Титульный лист** ([пример](Materials/Нормоконтроль/Титульный_лист_отчета.docx))
4. **Содержание**
5. **Введение**
6. **Основная часть**:
...
### Титульный лист
[пример](Materials/Нормоконтроль/Титульный_лист_отчета.docx)
...
## 📚 Библиографический список
  ...
  - [Оформление лит. источников](Materials/Оформление_лит._источников)
